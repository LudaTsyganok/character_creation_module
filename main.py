...
def attack(char_name: str, char_class: str):
    """Определяет урон, который нанёс игрок."""
...
def defence(char_name: str, char_class: str):
    """Определяет число блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    """Игрок применяет специальное умение."""
    if char_class == 'warrior':
...
def choice_char_class():
    """
    Выбор персонажа. Печать сообщения для игрока.
